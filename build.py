...
SECTIONS = [
    ...
    },
    {
        ...
        'subsections': [
            ...
            {'title': '제주대학교 아라캠퍼스 소개', 'file_key': '제주대학교 아라캠퍼스 254f7f2dc41f8064'},
            {'title': '마을과 함께 가꾸는 교육의 터전 (이인회 교수님 연구실)', 'file_key': '마을과 함께 가꾸는 교육의 터전'},
            {'title': '2025 프론티어방 하계 워크숍', 'file_key': '2025 프론티어방 하계 워크숍'},
            {'title': '제주대학교 사라캠퍼스 소개', 'file_key': '제주대학교 사라캠퍼스 25bf7f2dc41f80f3'},
            {'title': '2025 유럽 선진 숲 교육기관 연수 결과 보고 (고전 교수님 연구실)', 'file_key': '2025 유럽 선진 숲 교육기관 연수'},
            {'title': '신입생 소개 — 이선아 (연준모 교수님 연구실)', 'file_key': '신입생 소개 26cf7f2dc41f80df'},
            {'title': '신입생 소개 — 김신회 (박사과정)', 'file_key': '신입생 소개 28bf7f2dc41f80c5'},
        ]
    },
]
